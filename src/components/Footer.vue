  ...
  <footer>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-28">
      <div>
        <div class="flex gap-2 mb-5">
          <h1 class="text-white font-bold text-2xl">Халлов<span class="text-secondary">ээ</span>нд</h1>
        ...
        <p class="text-white leading-loose tracking-wide w-full md:w-[80%]">2023 оны хичээлийн жил, 3р улирал, Баасандорж багшийн заавар дор урласан Олон эгзэ сургуулийн 11а ангийн сурагчдын бүтээлийн цомгоос… Сурагч Аз-Очир.</p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center gap-12 text-white">
        <div>
          <h3 class="mb-4 font-bold text-2xl md:text-lg">Тухай</h3>
          <div class="flex flex-col gap-3">
            <a href="#" class="hover:underline">Бидний тухай</a>
            <a href="#" class="hover:underline">Онцлог</a>
            <a href="#" class="hover:underline">Карьэр</a>
          </div>
        </div>
        <div>
          <h3 class="mb-4 font-bold text-2xl md:text-lg">Компани</h3>
          <div class="flex flex-col gap-3">
            <a href="#" class="hover:underline">Манай баг</a>
            <a href="https://github.com/EnvyTheWise" class="hover:underline">Хамтрагчид</a>
            <a href="#" class="hover:underline">Асуулт</a>
          </div>
        </div>
        <div>
          <h3 class="mb-4 font-bold text-2xl md:text-lg">Үйлчилгээ</h3>
          <div class="flex flex-col gap-3">
            <a href="https://www.facebook.com/profile.php?id=100083205616866" class="hover:underline">Тусламж</a>
            <a href="https://www.facebook.com/profile.php?id=100021406149510" class="hover:underline">Санал хүсэлт</a>
            <a href="https://www.facebook.com/profile.php?id=100021406149510" class="hover:underline">Холбогдох</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid place-items-center my-20 w-full ">
      <div class="flex items-center gap-10">
        <a href="https://www.facebook.com/profile.php?id=100021406149510" class="bg-secondary h-12 w-12 grid place-items-center rounded-md">
        ...
        <a href="https://twitter.com/TvT929" class="bg-secondary h-12 w-12 grid place-items-center rounded-md">
          <img src="../assets/images/social/twitter.svg" alt="">
        </a>
      </div>
      <p class="md:text-lg font-medium text-center text-white mt-8 tracking-wider">
        &copy; Copyright, Халловейннд 2023, Бүх эрх хуулиар хамгаалагдсан.
      </p>
    </div>
  </footer>
</template>
  ...
  <nav ref="navbar" class="fixed top-0 left-0 w-full bg-primary-200 z-20 transition duration-200"> 
    <div class="container flex items-center justify-between h-20">
      <div class="relative z-30 flex items-center gap-2 mb-2 lg:mb-0">
        <h1 class="text-white font-bold text-lg lg:text-2xl">Халлов<span class="text-secondary">ээ</span>нд</h1>
      ...
      >
        <a @click="showMenu = false" class="text-white font-medium" href="#home">Нүүр</a>
        <a @click="showMenu = false" class="text-white font-medium" href="#category">Ангилал</a>
        <a @click="showMenu = false" class="text-white font-medium" href="#about">Бидний тухай</a>
        <a @click="showMenu = false" class="text-white font-medium" href="#trick-or-treat">Мэхэл эсвэл чихэр өг</a>
        <button class="hidden md:block px-8 py-3 rounded-full text-white font-medium tracking-wider uppercase bg-secondary w-full lg:w-auto">Хандивлах</button>
      </div>
    </div>
  </nav>
</template>